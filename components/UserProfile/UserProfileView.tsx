          ...
          <div className="xl:w-8/12">
            <div className="block rounded-lg bg-white shadow-lg">
              <div className="g-0 lg:flex lg:flex-wrap ">
                <div className="border-black-500 border-r-2 px-4 md:px-0 lg:w-8/12">
